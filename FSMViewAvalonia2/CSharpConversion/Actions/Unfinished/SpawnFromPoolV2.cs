...
{
    public static class SpawnFromPoolV2
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            FsmGameObject pool = action.Values[0].Item2 as FsmGameObject;
            FsmVector3 setPosition = action.Values[1].Item2 as FsmVector3;
            ...
            FsmString FSM = action.Values[8].Item2 as FsmString;
            FsmString FSMEvent = action.Values[9].Item2 as FsmString;
        }
    }
}