...
{
    public static class iTweenMoveFrom
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            ...
            string startEvent = action.Values[15].Item2 as string;
            string finishEvent = action.Values[16].Item2 as string;
            FsmBool realTime = action.Values[17].Item2 as FsmBool;
            FsmBool stopOnExit = action.Values[18].Item2 as FsmBool;
            FsmBool loopDontFinish = action.Values[19].Item2 as FsmBool;
        }
    }
}