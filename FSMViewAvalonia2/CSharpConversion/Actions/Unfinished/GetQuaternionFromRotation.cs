...
{
    public static class GetQuaternionFromRotation
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            FsmVector3 fromDirection = action.Values[0].Item2 as FsmVector3;
            FsmVector3 toDirection = action.Values[1].Item2 as FsmVector3;
