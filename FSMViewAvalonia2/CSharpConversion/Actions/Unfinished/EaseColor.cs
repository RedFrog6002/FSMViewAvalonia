...
{
    public static class EaseColor
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            FsmColor fromValue = action.Values[0].Item2 as FsmColor;
            FsmColor toValue = action.Values[1].Item2 as FsmColor;
            FsmColor colorVariable = action.Values[2].Item2 as FsmColor;
