...
{
    public static class ArrayListGetClosestGameObjectInSight
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            ...
            FsmGameObject closestGameObject = action.Values[8].Item2 as FsmGameObject;
            FsmInt closestIndex = action.Values[9].Item2 as FsmInt;
        }
    }
}