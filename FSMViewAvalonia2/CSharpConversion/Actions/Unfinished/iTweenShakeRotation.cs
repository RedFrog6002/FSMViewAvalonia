...
{
    public static class iTweenShakeRotation
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            ...
            string startEvent = action.Values[7].Item2 as string;
            string finishEvent = action.Values[8].Item2 as string;
            FsmBool realTime = action.Values[9].Item2 as FsmBool;
            FsmBool stopOnExit = action.Values[10].Item2 as FsmBool;
            FsmBool loopDontFinish = action.Values[11].Item2 as FsmBool;
        }
    }
}