...
{
    public static class ArrayListGetFarthestGameObject
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            ...
            FsmGameObject farthestGameObject = action.Values[5].Item2 as FsmGameObject;
            FsmInt farthestIndex = action.Values[6].Item2 as FsmInt;
        }
    }
}