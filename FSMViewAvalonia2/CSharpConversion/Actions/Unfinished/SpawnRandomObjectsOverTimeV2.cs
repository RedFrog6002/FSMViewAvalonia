...
{
    public static class SpawnRandomObjectsOverTimeV2
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            ...
            FsmFloat scaleMin = action.Values[12].Item2 as FsmFloat;
            FsmFloat scaleMax = action.Values[13].Item2 as FsmFloat;
        }
    }
}