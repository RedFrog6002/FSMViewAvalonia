...
{
    public static class TransformInputToWorldSpace
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            FsmFloat horizontalInput = action.Values[0].Item2 as FsmFloat;
            FsmFloat verticalInput = action.Values[1].Item2 as FsmFloat;
