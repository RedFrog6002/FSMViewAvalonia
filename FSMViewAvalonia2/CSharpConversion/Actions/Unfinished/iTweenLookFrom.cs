...
{
    public static class iTweenLookFrom
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            FsmOwnerDefault gameObject = action.Values[0].Item2 as FsmOwnerDefault;
            FsmString id = action.Values[1].Item2 as FsmString;
            FsmGameObject transformTarget = action.Values[2].Item2 as FsmGameObject;
            FsmVector3 vectorTarget = action.Values[3].Item2 as FsmVector3;
