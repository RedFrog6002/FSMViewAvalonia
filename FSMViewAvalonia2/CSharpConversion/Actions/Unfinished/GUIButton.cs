...
namespace FSMViewAvalonia2.CSharpConversion.Actions
{
    public static class GUIButton
    {
        public static void Build(FsmStateBuilder state, ActionScriptEntry action, FsmStateData data)
        {
            ...
            FsmRect screenRect = action.Values[6].Item2 as FsmRect;
            FsmFloat left = action.Values[7].Item2 as FsmFloat;
            FsmFloat top = action.Values[8].Item2 as FsmFloat;
            FsmFloat width = action.Values[9].Item2 as FsmFloat;
            FsmFloat height = action.Values[10].Item2 as FsmFloat;
            FsmBool normalized = action.Values[11].Item2 as FsmBool;
        }
    }
}